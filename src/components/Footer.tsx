      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start">
        ...
        <div className="w-full md:w-1/3">
         ...
         <p className="text-gray-400 mb-4 max-w-80">
           The latest news, articles, and updates delivered to your inbox weekly.
         </p>
<div className="flex flex-col md:flex-row gap-2">
    <input type="email" placeholder="Enter your email"
     className="bg-gray-800 text-gray-400 p-2 rounded border-gray-700
      focus:outline-none w-full md:w-auto" />
      <button className="bg-blue-600 py-2 px-4 text-white rounded">
        Subscribe
      </button>
</div>
